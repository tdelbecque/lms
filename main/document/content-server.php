...
if (this === $("#content-server_curdirpath")[0]) {
...
// form title
$form->addElement('header', 'Content Server');
...
//$form->addText('content', get_lang('Content Reference'), true, array('cols-size' => [2, 10, 0], 'autofocus'));

$serverSelect = $form -> addSelect ('contentServer', get_lang('Serveur de contenu'), null, array('cols-size' => [2, 10, 0]));
$serverSelect -> addOption ("Pollux", "");
$contentSelect = $form -> addSelect ('content', get_lang('Référence du contenu'), null, array('cols-size' => [2, 10, 0]));
$contentSelect -> addOption ("Intégrales Euleriennes", "http://shiny.plx.ovh/beta/");
$contentSelect -> addOption ("Rappel sur les ensembles", "http://shiny.plx.ovh/cehj_shiny_probastat_exo_ch1_cours/");
...
if ($form->validate()) {
    ...
    $extension = 'html';
    $content = "<html><body><div style=\"max-width: 800px; margin: auto\"><iframe frameborder=\"0\" height=\"100%\" scrolling=\"yes\" src=\"" . Security::remove_XSS($values['content'], COURSEMANAGERLOWSECURITY) . "\" width=\"100%\"></iframe></div></body></html>";
