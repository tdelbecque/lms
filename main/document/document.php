...
$thyPluginInstalled = in_array ('content-server', $pluginList);
...
if ($isAllowedToEdit ||
    ...
    if ($thyPluginInstalled) {
      $actionsLeft .= Display::url(Display::return_icon ('thy.png', get_lang ('ContentServer'), '', ICON_SIZE_MEDIUM),
				   api_get_path(WEB_CODE_PATH).'document/content-server.php');
    }
