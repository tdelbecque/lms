...
if ($is_certificate_mode) {//added condition for certicate in gradebook
    ...
    error_log ("PT0 : " . json_encode ($form->exportValues()));
...
$current_session_id = api_get_session_id();
    error_log ("PT1 : " . json_encode ($editorConfig));
$form->addHtmlEditor(
    'content',
    get_lang('Content'),
    true,
    ...
    error_log ("PT2 : " . json_encode ($form->exportValues()));
...
if ($form->validate()) {
    ...
    error_log ("PT5 : " . json_encode ($values));
